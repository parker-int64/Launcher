...
本章说明 APPLaunch 如何把内置页面、终端命令、外部独立程序统一成一个应用列表，以及用户按 Enter 后如何启动应用。重点参考 `projects/APPLaunch/main/ui/Launch.cpp`、`projects/APPLaunch/main/ui/Launch.h`、`projects/APPLaunch/main/ui/UILaunchPage.cpp`、`projects/APPLaunch/main/ui/page_app/*`。
